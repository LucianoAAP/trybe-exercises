...
app.get('/employees/:id', async (req, res) => {
  try {
    ...
    // if (req.query.includeAddresses === 'true') { // lazy loading
...
// app.post('/employees', async (req, res) => { // unmanaged transaction
...
app.post('/employees', async (req, res) => { // managed transaction
  try {
    const { firstName, lastName, age, city, street, number } = req.body;
